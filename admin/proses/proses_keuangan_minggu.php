...
if (isset($_POST['simpan_keuangan_minggu'])) {
    ...
    header("Location: ../admin_dashboard.php?pesan=sukses_keuangan&tab=admin-keuangan&subtab=minggu&tgl_keuangan=$tanggal");
    exit;
} else {
    header("Location: ../admin_dashboard.php?tab=admin-keuangan&subtab=minggu");
    exit;
}
?>